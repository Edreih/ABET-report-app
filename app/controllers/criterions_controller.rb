class CriterionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @criterion.save
        format.html { redirect_to @criterion, notice: 'Criteria was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @criterion.update(criterion_params)
        format.html { redirect_to @criterion, notice: 'Criteria was successfully updated.' }
  ...
  def destroy
    @criterion.destroy
    respond_to do |format|
      format.html { redirect_to criterions_url, notice: 'Criteria was successfully deleted.' }
  ...
  private
    ...
    def criterion_params
      params.require(:criterion).permit(:name, :description, :string)
    end
end
