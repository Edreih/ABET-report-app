...
class AdministratorsTest < ApplicationSystemTestCase
  ...
  test "creating a Administrator" do
    ...
    fill_in "Fname", with: @administrator.fname
    fill_in "Lname", with: @administrator.lname
    fill_in "Office", with: @administrator.office
    fill_in "Phone", with: @administrator.phone
