...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { email: @administrator.email, fname: @administrator.fname, lname: @administrator.lname, office: @administrator.office, phone: @administrator.phone, title: @administrator.title } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { email: @administrator.email, fname: @administrator.fname, lname: @administrator.lname, office: @administrator.office, phone: @administrator.phone, title: @administrator.title } }
