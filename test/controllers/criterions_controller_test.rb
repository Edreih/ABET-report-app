...
class CriterionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create criterion" do
    assert_difference('Criterion.count') do
      post criterions_url, params: { criterion: { description: @criterion.description, name: @criterion.name, string: @criterion.string } }
    end
  ...
  test "should update criterion" do
    patch criterion_url(@criterion), params: { criterion: { description: @criterion.description, name: @criterion.name, string: @criterion.string } }
