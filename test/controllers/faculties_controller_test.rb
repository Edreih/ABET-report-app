...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { email: @faculty.email, fname: @faculty.fname, lname: @faculty.lname, office: @faculty.office, phone: @faculty.phone, title: @faculty.title } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { email: @faculty.email, fname: @faculty.fname, lname: @faculty.lname, office: @faculty.office, phone: @faculty.phone, title: @faculty.title } }
