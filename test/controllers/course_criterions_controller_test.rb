...
class CourseCriterionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_criterion" do
    assert_difference('CourseCriterion.count') do
      post course_criterions_url, params: { course_criterion: { course: @course_criterion.course, course_id: @course_criterion.course_id, criterion_id: @course_criterion.criterion_id, criterion_threshold_id: @course_criterion.criterion_threshold_id, description: @course_criterion.description, score: @course_criterion.score } }
    end
  ...
  test "should update course_criterion" do
    patch course_criterion_url(@course_criterion), params: { course_criterion: { course: @course_criterion.course, course_id: @course_criterion.course_id, criterion_id: @course_criterion.criterion_id, criterion_threshold_id: @course_criterion.criterion_threshold_id, description: @course_criterion.description, score: @course_criterion.score } }
